 ...
 */
@Entity
@Table(name = "mdc_regulateur")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class MdcRegulateur implements Serializable {
    ...
    public MdcRegulateur nom(String nom) {
        this.nom = nom;
        return this;
    }
    ...
    public MdcRegulateur prenom(String prenom) {
        this.prenom = prenom;
        return this;
    }
    ...
    public MdcRegulateur adresse(String adresse) {
    ...
    public MdcRegulateur telephone(String telephone) {
    ...
    public MdcRegulateur centre(TypeCentre centre) {
        this.centre = centre;
        return this;
    }
    ...
    public MdcRegulateur etat(Etat etat) {
        this.etat = etat;
        return this;
    }
    ...
    public MdcRegulateur estMobile(Boolean estMobile) {
    ...
    public MdcRegulateur estFixe(Boolean estFixe) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MdcRegulateur)) {
            return false;
        }
        return id != null && id.equals(((MdcRegulateur) o).id);
    }
