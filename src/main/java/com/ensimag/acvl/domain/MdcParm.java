...
public class MdcParm implements Serializable {
    ...
    public MdcParm prenom(String prenom) {
        this.prenom = prenom;
        return this;
    }
    ...
    public MdcParm adresse(String adresse) {
    ...
    public MdcParm telephone(String telephone) {
    ...
    public MdcParm centre(TypeCentre centre) {
        this.centre = centre;
        return this;
    }
    ...
    public MdcParm estMobile(Boolean estMobile) {
    ...
    public MdcParm estFixe(Boolean estFixe) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MdcParm)) {
            return false;
        }
        return id != null && id.equals(((MdcParm) o).id);
    }
