 ...
 */
@Entity
@Table(name = "medecin_parm")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class MedecinParm implements Serializable {
    ...
    public MedecinParm nom(String nom) {
        this.nom = nom;
        return this;
    }
    ...
    public MedecinParm prenom(String prenom) {
        this.prenom = prenom;
        return this;
    }
    ...
    public MedecinParm adresse(String adresse) {
    ...
    public MedecinParm telephone(String telephone) {
    ...
    public MedecinParm centre(TypeCentre centre) {
        this.centre = centre;
        return this;
    }
    ...
    public MedecinParm etat(Etat etat) {
        this.etat = etat;
        return this;
    }
    ...
    public MedecinParm estMobile(Boolean estMobile) {
    ...
    public MedecinParm estFixe(Boolean estFixe) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MedecinParm)) {
            return false;
        }
        return id != null && id.equals(((MedecinParm) o).id);
    }
