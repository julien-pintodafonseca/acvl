 ...
 */
@Entity
@Table(name = "medecin_mobile")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class MedecinMobile implements Serializable {
    ...
    public MedecinMobile nom(String nom) {
        this.nom = nom;
        return this;
    }
    ...
    public MedecinMobile prenom(String prenom) {
        this.prenom = prenom;
        return this;
    }
    ...
    public MedecinMobile adresse(String adresse) {
    ...
    public MedecinMobile telephone(String telephone) {
    ...
    public MedecinMobile centre(TypeCentre centre) {
        this.centre = centre;
        return this;
    }
    ...
    public MedecinMobile etat(Etat etat) {
        this.etat = etat;
        return this;
    }
    ...
    public MedecinMobile estMobile(Boolean estMobile) {
    ...
    public MedecinMobile estFixe(Boolean estFixe) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MedecinMobile)) {
            return false;
        }
        return id != null && id.equals(((MedecinMobile) o).id);
    }
