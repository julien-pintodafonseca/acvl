 ...
 */
@Entity
@Table(name = "medecin_fixe")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class MedecinFixe implements Serializable {
    ...
    public MedecinFixe nom(String nom) {
        this.nom = nom;
        return this;
    }
    ...
    public MedecinFixe prenom(String prenom) {
        this.prenom = prenom;
        return this;
    }
    ...
    public MedecinFixe adresse(String adresse) {
    ...
    public MedecinFixe telephone(String telephone) {
    ...
    public MedecinFixe centre(TypeCentre centre) {
        this.centre = centre;
        return this;
    }
    ...
    public MedecinFixe etat(Etat etat) {
        this.etat = etat;
        return this;
    }
    ...
    public MedecinFixe estMobile(Boolean estMobile) {
    ...
    public MedecinFixe estFixe(Boolean estFixe) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MedecinFixe)) {
            return false;
        }
        return id != null && id.equals(((MedecinFixe) o).id);
    }
