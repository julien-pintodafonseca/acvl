 ...
 */
@Entity
@Table(name = "personnel_sante")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class PersonnelSante implements Serializable {
    ...
    public PersonnelSante nom(String nom) {
        this.nom = nom;
        return this;
    }
    ...
    public PersonnelSante prenom(String prenom) {
        this.prenom = prenom;
        return this;
    }
    ...
    public PersonnelSante adresse(String adresse) {
    ...
    public PersonnelSante telephone(String telephone) {
    ...
    public PersonnelSante centre(TypeCentre centre) {
        this.centre = centre;
        return this;
    }
    ...
    public PersonnelSante etat(Etat etat) {
        this.etat = etat;
        return this;
    }
    ...
    public PersonnelSante estMobile(Boolean estMobile) {
    ...
    public PersonnelSante estFixe(Boolean estFixe) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PersonnelSante)) {
            return false;
        }
        return id != null && id.equals(((PersonnelSante) o).id);
    }
