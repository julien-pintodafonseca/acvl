...
public class Infirmier implements Serializable {
    ...
    public Infirmier adresse(String adresse) {
    ...
    public Infirmier telephone(String telephone) {
    ...
    public Infirmier centre(TypeCentre centre) {
        this.centre = centre;
        return this;
    }
    ...
    public Infirmier etat(Etat etat) {
        this.etat = etat;
        return this;
    }
    ...
    public Infirmier estMobile(Boolean estMobile) {
    ...
    public Infirmier estFixe(Boolean estFixe) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Infirmier)) {
            return false;
        }
        return id != null && id.equals(((Infirmier) o).id);
    }
