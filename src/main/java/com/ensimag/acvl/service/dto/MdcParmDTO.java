...
/**
 * A DTO for the {@link com.ensimag.acvl.domain.MdcParm} entity.
 */
public class MdcParmDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MdcParmDTO)) {
            return false;
        }

        return id != null && id.equals(((MdcParmDTO) o).id);
    }
