...
/**
 * A DTO for the {@link com.ensimag.acvl.domain.MdcFixe} entity.
 */
public class MdcFixeDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MdcFixeDTO)) {
            return false;
        }

        return id != null && id.equals(((MdcFixeDTO) o).id);
    }
