...
/**
 * A DTO for the {@link com.ensimag.acvl.domain.MedecinParm} entity.
 */
public class MedecinParmDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MedecinParmDTO)) {
            return false;
        }

        return id != null && id.equals(((MedecinParmDTO) o).id);
    }
