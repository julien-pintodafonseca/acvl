...
/**
 * A DTO for the {@link com.ensimag.acvl.domain.Infirmier} entity.
 */
public class InfirmierDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof InfirmierDTO)) {
            return false;
        }

        return id != null && id.equals(((InfirmierDTO) o).id);
    }
