...
/**
 * A DTO for the {@link com.ensimag.acvl.domain.MedecinRegulateur} entity.
 */
public class MedecinRegulateurDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MedecinRegulateurDTO)) {
            return false;
        }

        return id != null && id.equals(((MedecinRegulateurDTO) o).id);
    }
