...
/**
 * A DTO for the {@link com.ensimag.acvl.domain.MedecinMobile} entity.
 */
public class MedecinMobileDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MedecinMobileDTO)) {
            return false;
        }

        return id != null && id.equals(((MedecinMobileDTO) o).id);
    }
