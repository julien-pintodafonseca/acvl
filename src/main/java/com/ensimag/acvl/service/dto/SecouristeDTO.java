...
/**
 * A DTO for the {@link com.ensimag.acvl.domain.Secouriste} entity.
 */
public class SecouristeDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SecouristeDTO)) {
            return false;
        }

        return id != null && id.equals(((SecouristeDTO) o).id);
    }
