...
/**
 * A DTO for the {@link com.ensimag.acvl.domain.MedecinFixe} entity.
 */
public class MedecinFixeDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MedecinFixeDTO)) {
            return false;
        }

        return id != null && id.equals(((MedecinFixeDTO) o).id);
    }
