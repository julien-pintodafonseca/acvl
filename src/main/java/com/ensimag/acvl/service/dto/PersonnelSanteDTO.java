...
/**
 * A DTO for the {@link com.ensimag.acvl.domain.PersonnelSante} entity.
 */
public class PersonnelSanteDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PersonnelSanteDTO)) {
            return false;
        }

        return id != null && id.equals(((PersonnelSanteDTO) o).id);
    }
