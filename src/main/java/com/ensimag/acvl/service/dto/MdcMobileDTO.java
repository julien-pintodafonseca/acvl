...
/**
 * A DTO for the {@link com.ensimag.acvl.domain.MdcMobile} entity.
 */
public class MdcMobileDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MdcMobileDTO)) {
            return false;
        }

        return id != null && id.equals(((MdcMobileDTO) o).id);
    }
